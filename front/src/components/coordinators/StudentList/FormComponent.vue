<template>
    <form class="px-5 pt-6 mb-5 box-border" @submit.prevent="onSubmit">
        ...
        <div class="flex items-center justify-end space-x-1 px-2 border-slate-200 mt-4 rounded-b">
            <button-add
            ...
            <button-add
                class="btn-submit text-white active:bg-sky-600 text-sm text-sm px-2 rounded shadow hover:shadow-lg hover:bg-sky-500 outline-none focus:outline-none"
                type="submit">
                Create
            </button-add>
        </div>
