<template>
  <div class="student">
    <div class="student relative" v-if="is_show_form_tutor == false">
      ...
      <table class="bg-white w-[82.6%] m-auto box-border mt-[-0.5rem]">
    ...
    <div class="tutor">
      <student-follow-up v-if="is_show_form_tutor" :student_id="student_id" @move_student_to_follow_up="move_student_to_follow_up" @cancle="on_cancle"></student-follow-up>
    </div>
  </div>
  <!-------------------------------------end-view-------------------------------->
</template>
