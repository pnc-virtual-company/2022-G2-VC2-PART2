      ...
      <div class="container p-9 h-full">
        <div class="flex justify-center items-center w-10/12 m-auto g-6 h-full">
          ...
          <div class="w-2/5 bg-white rounded ml-6">
            <form
              class="w-full m-auto px-6 py-5 box-border"
              @submit.prevent="on_login"
            >
              ...
              <div class="mb-6 mt-6 flex">
                <div
                  class="mail bg-primary px-4 flex justify-center items-center rounded-l"
                >
                  <svg
              ...
              <small id="smali1" v-if="email_validation"
                >Email is required</small
              >
              <!-- Password input -->
              <div class="mb-8 mt-8 flex py-2">
                <div
                  class="pass bg-primary px-4 flex justify-center items-center rounded-l"
                >
                  <svg
                    class="h-8 w-8 text-white"
                    viewBox="0 0 24 24"
              ...
              <small id="smali2" v-if="password_validation"
...
export default {
  ...
  methods: {
    ...
    close_form() {
      this.show_form = true;
      this.$emit('show_login', this.show_form)
